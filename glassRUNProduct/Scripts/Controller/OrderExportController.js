angular.module("glassRUNProduct").controller('OrderExportController', function ($scope, $timeout, $rootScope, $ionicModal, $filter, $location, $sessionStorage, $state, pluginsService, focus, GrRequestService) {
    ...
    $scope.LoadSalesAdminApprovalGrid = function () {
        ...
        var SalesAdminApprovalData = new DevExpress.data.CustomStore({
            load: function (loadOptions) {
                ...
                var TripProfit = "";
                var TripProfitPerCent = "";
                var PaymentAdvanceAmount = "";
                var PaymentRequestDate = "";
                var PaymentRequestStatus = "";
                var BillingStatus = "";
                var BillingCreditedAmount = "";
                var BillingCreditedAmountStatus = "";
                var BillingCreditedAmountDate = "";
                var BalanceAmount = "";
                var BalAmtStatus = "";
                var BalanceAmountDate = "";
                var TripProfitCriteria = "";
                var TripProfitPerCentCriteria = "";
                var PaymentAdvanceAmountCriteria = "";
                var PaymentRequestDateCriteria = "";
                var PaymentRequestStatusCriteria = "";
                var BillingStatusCriteria = "";
                var BillingCreditedAmountCriteria = "";
                var BillingCreditedAmountStatusCriteria = "";
                var BillingCreditedAmountDateCriteria = "";
                var BalanceAmountCriteria = "";
                var BalAmtStatusCriteria = "";
                var BalanceAmountDateCriteria = "";
                ...
                if (filterOptions != "") {
                    ...
                    for (var i = 0; i < fields.length; i++) {
                        ...
                        /////Export
                        if (columnsList[0] === "PaymentRequestDate") {
                            if (PaymentRequestDate === "") {
                                if (fields.length > 1) {
                                    PaymentRequestDateCriteria = "=";
                                } else {
                                    PaymentRequestDateCriteria = columnsList[1];
                                }
                                PaymentRequestDate = columnsList[2];
                                PaymentRequestDate = new Date(PaymentRequestDate);
                                PaymentRequestDate = $filter('date')(PaymentRequestDate, "dd/MM/yyyy");
                            }
                        }

                        if (columnsList[0] === "BillingCreditedAmountDate") {
                            if (BillingCreditedAmountDate === "") {
                                if (fields.length > 1) {
                                    BillingCreditedAmountDateCriteria = "=";
                                } else {
                                    BillingCreditedAmountDateCriteria = columnsList[1];
                                }
                                BillingCreditedAmountDate = columnsList[2];
                                BillingCreditedAmountDate = new Date(BillingCreditedAmountDate);
                                BillingCreditedAmountDate = $filter('date')(BillingCreditedAmountDate, "dd/MM/yyyy");
                            }
                        }


                        if (columnsList[0] === "BalanceAmountDate") {
                            if (BalanceAmountDate === "") {
                                if (fields.length > 1) {
                                    BalanceAmountDateCriteria = "=";
                                } else {
                                    BalanceAmountDateCriteria = columnsList[1];
                                }
                                BalanceAmountDate = columnsList[2];
                                BalanceAmountDate = new Date(BalanceAmountDate);
                                BalanceAmountDate = $filter('date')(BalanceAmountDate, "dd/MM/yyyy");
                            }
                        }


                        if (columnsList[0] === "TripProfit") {
                            if (TripProfit === "") {
                                if (fields.length > 1) {
                                    TripProfitCriteria = "=";
                                } else {
                                    TripProfitCriteria = columnsList[1];
                                }
                                TripProfitCriteria = columnsList[1];
                                TripProfit = columnsList[2];
                            }
                        }


                        if (columnsList[0] === "TripProfitPerCent") {
                            if (TripProfitPerCent === "") {
                                if (fields.length > 1) {
                                    TripProfitPerCentCriteria = "=";
                                } else {
                                    TripProfitPerCentCriteria = columnsList[1];
                                }
                                TripProfitCriteria = columnsList[1];
                                TripProfitPerCent = columnsList[2];
                            }
                        }


                        if (columnsList[0] === "PaymentAdvanceAmount") {
                            if (PaymentAdvanceAmount === "") {
                                if (fields.length > 1) {
                                    PaymentAdvanceAmountCriteria = "=";
                                } else {
                                    PaymentAdvanceAmountCriteria = columnsList[1];
                                }
                                PaymentAdvanceAmountCriteria = columnsList[1];
                                PaymentAdvanceAmount = columnsList[2];
                            }
                        }


                        if (columnsList[0] === "BillingCreditedAmount") {
                            if (BillingCreditedAmount === "") {
                                if (fields.length > 1) {
                                    BillingCreditedAmountCriteria = "=";
                                } else {
                                    BillingCreditedAmountCriteria = columnsList[1];
                                }
                                BillingCreditedAmountCriteria = columnsList[1];
                                BillingCreditedAmount = columnsList[2];
                            }
                        }

                        if (columnsList[0] === "BalanceAmount") {
                            if (BalanceAmount === "") {
                                if (fields.length > 1) {
                                    BalanceAmountCriteria = "=";
                                } else {
                                    BalanceAmountCriteria = columnsList[1];
                                }
                                BillingCreditedAmountCriteria = columnsList[1];
                                BalanceAmount = columnsList[2];
                            }
                        }

                        if (columnsList[0] === "PaymentRequestStatus") {
                            PaymentRequestStatusCriteria = columnsList[1];
                            PaymentRequestStatus = columnsList[2];
                        }

                        if (columnsList[0] === "BillingStatus") {
                            BillingStatusCriteria = columnsList[1];
                            BillingStatus = columnsList[2];
                        }

                        if (columnsList[0] === "BillingCreditedAmountStatus") {
                            BillingCreditedAmountStatusCriteria = columnsList[1];
                            BillingCreditedAmountStatus = columnsList[2];
                        }

                        if (columnsList[0] === "BalAmtStatus") {
                            BalAmtStatusCriteria = columnsList[1];
                            BalAmtStatus = columnsList[2];
                        }
                        /////Export
                ...
                var requestData =
                    {
                        ...
                        TripProfitPerCent: TripProfitPerCent,
                        PaymentAdvanceAmount: PaymentAdvanceAmount,
                        PaymentRequestDate: PaymentRequestDate,
                        PaymentRequestStatus: PaymentRequestStatus,
                        BillingStatus: BillingStatus,
                        BillingCreditedAmount: BillingCreditedAmount,
                        BillingCreditedAmountStatus: BillingCreditedAmountStatus,
                        BillingCreditedAmountDate: BillingCreditedAmountDate,
                        BalanceAmount: BalanceAmount,
                        BalAmtStatus: BalAmtStatus,
                        BalanceAmountDate: BalanceAmountDate,
                        TripProfitCriteria: TripProfitCriteria,
                        TripProfitPerCentCriteria: TripProfitPerCentCriteria,
                        PaymentAdvanceAmountCriteria: PaymentAdvanceAmountCriteria,
                        PaymentRequestDateCriteria: PaymentRequestDateCriteria,
                        PaymentRequestStatusCriteria: PaymentRequestStatusCriteria,
                        BillingStatusCriteria: BillingStatusCriteria,
                        BillingCreditedAmountCriteria: BillingCreditedAmountCriteria,
                        BillingCreditedAmountStatusCriteria: BillingCreditedAmountStatusCriteria,
                        BillingCreditedAmountDateCriteria: BillingCreditedAmountDateCriteria,
                        BalanceAmountCriteria: BalanceAmountCriteria,
                        BalAmtStatusCriteria: BalAmtStatusCriteria,
                        BalanceAmountDateCriteria: BalanceAmountDateCriteria
                    };
        ...
        $scope.GetAllDriverPlateNumberUpdated = function () {
            ...
            var enquiryDetails = $scope.SalesAdminApprovalList.filter(function (el) { return el.CheckedEnquiry === true && el.IsCompleted !== '1'; });
        ...
        $scope.GetAssignTransporterUpdated = function () {
            ...
            if (enquiryDetails.length > 0) {
                ...
                GrRequestService.ProcessRequest(consolidateApiParamater).then(function (response) {
                    ...
                    $scope.RefreshDataGrid();
                    $rootScope.ValidationErrorAlert('Transport assign successfully.', 'error', 8000);
        ...
        $scope.SalesAdminApprovalGrid = {
            ...
            columns: [
                ...
                {
                    dataField: "BillingCreditedAmountDate",
                    dataType: "date",
                    format: "dd/MM/yyyy",
                    filterOperations: ['=', '>', '<'],
                    alignment: "right",
                ...
                {
                    dataField: "BalAmtStatus",
                    alignment: "left",
                },
                {
                    dataField: "BillingCreditedAmountStatus",
                    alignment: "left",
                },
                {
                    dataField: "TripProfit",
                    alignment: "right",
                    filterOperations: ['=', '>', '<'],
                },
                {
                    dataField: "TripProfitPerCent",
                    alignment: "right",
                    filterOperations: ['=', '>', '<'],
                },
                {
                    dataField: "PaymentAdvanceAmount",
                    alignment: "right",
                    filterOperations: ['=', '>', '<'],
                },
                {
                    dataField: "BillingCreditedAmount",
                    alignment: "right",
                    filterOperations: ['=', '>', '<'],
                },
                {
