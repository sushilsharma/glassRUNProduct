angular.module("glassRUNProduct").controller('OrderGridTruckOutController', function ($scope, $rootScope, $sessionStorage, $state, $filter, $ionicModal, $location, pluginsService, GrRequestService) {
                ...
                dataSource: {
                    ...
                    transport: {
                        read: function (options) {
                            ...
                            ''
                            var TruckOutTime = "(TruckOutDateTime is NOT NULL) and  (TruckOutDateTime != '1900-01-01 00:00:00.000')";
                            var TruckOutTimeCriteria = "default";
                            ...
                            var requestData =
                                {
                                    ...
                                    TruckOutTime: TruckOutTime,
                                    TruckOutTimeCriteria: TruckOutTimeCriteria
                                };
