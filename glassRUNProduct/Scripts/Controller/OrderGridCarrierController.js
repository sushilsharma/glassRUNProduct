angular.module("glassRUNProduct").controller('OrderGridCarrierController', function ($scope, $rootScope, $sessionStorage, $state, $filter, $ionicModal, $location, pluginsService, GrRequestService) {
        debugger;
        ...
        $scope.OrderDetailsGrid =
            {
                        ...
                        read: function (options) {
                            ...
                            if (options.data && options.data.filter && options.data.filter.filters) {
                                ...
                                for (var i = 0; i < options.data.filter.filters.length; i++) {
                                    ...
                                    if (options.data.filter.filters[i].field === "ShortName") {
                                        ShortName = options.data.filter.filters[i].value;
                                        ShortNameCriteria = options.data.filter.filters[i].operator;
                ...
                columns: [
                    ...
                    {
                        field: "ShortName", title: $rootScope.resData.res_GridColumn_ShortName, type: "string", filterable: { mode: "row", extra: false }, width: "150px"
                    },
                    ...
                    {
                        field: "PlateNumber",
                        template: "<select class=\"form-control\" style=\"margin:0px !important\"  ng-model=\"dataItem.PlateNumber\"  ng-change=\"GetDriverAccToPlateNumber(dataItem.PlateNumber,#=OrderId#)\"   ng-options=\"obj.TransporterVehicleRegistrationNumber as obj.TransporterVehicleRegistrationNumber for obj in PlateNumberList\"><option value=\"\">Select</option></select>",
                    ...
                    { field: "PlateNumberUpdate", title: "Plate Number Update", template: "<a class=\"greenbgfont approvebtn\" ng-if=\"dataItem.CurrentState !== '1104' && dataItem.CurrentState !== '1105' && dataitem.CurrentState!=34\" ng-click=\"ClickToUpdateStatusAndPlateNumber('#=SalesOrderNumber#',dataItem.PlateNumber,#=CurrentState#)\">  Update </a>", type: "string", filterable: false, width: "150px" },
