angular.module("glassRUNProduct").controller('OrderGridCustController', function ($scope, $rootScope, $sessionStorage, $state, $filter, $ionicModal, $location, pluginsService, GrRequestService) {
        debugger;
        ...
        $scope.OrderDetailsGrid =
            {
                ...
                columns: [
                 ...
                 { field: "DeliveryLocation", title: $rootScope.resData.res_GridColumn_DeliveryLocation, type: "string", filterable: { mode: "row", extra: false }, width: "100px" },
                    ...
                    {
                        field: "Action",
                        title: $rootScope.resData.res_GridColumn_ActionConfirmDelivery,
                        template: "#if(CurrentState === '1105') {#<a class=\"greenbgfont approvebtn\" ng-click=\"ConfirmDelivery('#=OrderId#')\">Order Received</a>#} else {#<span class='redbgfont'></span>#}#",
                        filterable: false,
                        width: "150px"
                    },
