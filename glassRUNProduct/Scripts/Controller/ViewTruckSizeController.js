angular.module("glassRUNProduct").controller('ViewTruckSizeController', function ($scope, $rootScope, $filter, $location, $sessionStorage, $ionicModal, $state, focus, pluginsService, GrRequestService) {
    ...
    $rootScope.LoadTruckSizeByDeliveryLocation = function (locationId) {
        ...
        var requestDataforTruckInfo =
            {
                UserId: $rootScope.UserId,
                ObjectId: 0,
                ObjectType: "Json structure for Truck Info : EnquiryId " + $rootScope.EditedEnquiryId + "",
                ServicesAction: 'CreateLog',
                LogDescription: 'Json structure for Truck Info : ' + JSON.stringify(jsonobject) + '. IsSelfCollect User :' + $rootScope.IsSelfCollect + '',
                LogDate: GetCurrentdate(),
                Source: 'Portal',
            };
        var consolidateApiParamaterTruckInfo =
            {
                Json: requestDataforTruckInfo,
            };

        GrRequestService.ProcessRequest(consolidateApiParamaterTruckInfo).then(function (responseLogItemAllocationValidation) {
                    ...
                    var requestDataforTruckInfo =
                        {
                            UserId: $rootScope.UserId,
                            ObjectId: 0,
                            ObjectType: "Truck List Response Json: EnquiryId " + $rootScope.EditedEnquiryId + "",
                            ServicesAction: 'CreateLog',
                            LogDescription: 'Truck List Response Json: ' + JSON.stringify($scope.bindTruckSize) + '.',
                            LogDate: GetCurrentdate(),
                            Source: 'Portal',
                        };
                    var consolidateApiParamaterTruckInfo =
