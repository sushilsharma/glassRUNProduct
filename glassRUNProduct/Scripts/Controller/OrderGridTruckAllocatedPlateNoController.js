angular.module("glassRUNProduct").controller('OrderGridTruckAllocatedPlateNoController', function ($scope, $rootScope, $sessionStorage, $state, $filter, $ionicModal, $location, pluginsService, GrRequestService) {
        ...
        $scope.OrderDetailsGrid =
            {
                ...
                dataSource: {
                    ...
                    transport: {
                        read: function (options) {
                            ...
                            var AllocatedPlateNo = "PlateNumberData is NOT NULL";
                            var AllocatedPlateNoCriteria = "default";
                            ...
                            var requestData =
                                {
                                    ...
                                    AllocatedPlateNo: AllocatedPlateNo,
                                    AllocatedPlateNoCriteria: AllocatedPlateNoCriteria
                                };
                ...
                columns: [
                    ...
                    {
                        field: "PlateNumberData", template: '<a class="graybgfont">#:PlateNumberData#</a>',
                        title: 'Plate Number', type: "string", filterable: { mode: "row", extra: false },
                        width: "200px"
                    },
