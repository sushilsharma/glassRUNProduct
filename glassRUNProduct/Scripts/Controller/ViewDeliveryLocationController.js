angular.module("glassRUNProduct").controller('ViewDeliveryLocationController', function ($scope, $rootScope, $filter, $location, $sessionStorage, $ionicModal, $state, focus, pluginsService, GrRequestService) {
                ...
                if (resoponsedata.DeliveryLocation !== undefined) {
                    ...
                    if ($rootScope.bindDeliverylocation.length === 1) {
                        ...
                        if ($rootScope.isEnquiryEdit === true) {
                            $rootScope.DeliveryLocationId = $scope.EditedEnquiryDeliveryLocationId;
                            $scope.GetDeliveryLocationDetailsByDeliveryLocationId($scope.EditedEnquiryDeliveryLocationId);
                        } else {
