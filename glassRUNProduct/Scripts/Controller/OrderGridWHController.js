angular.module("glassRUNProduct").controller('OrderGridWHController', function ($scope, $rootScope, $sessionStorage, $state, $filter, $ionicModal, $location, pluginsService, GrRequestService) {
    debugger;
