angular.module("glassRUNProduct").controller('OMInquiryDetailsController', function ($scope, $rootScope, $ionicModal, $filter, $location, $sessionStorage, $state, pluginsService, GrRequestService) {
    debugger;
    ...
    $scope.InquiryDetailsGrid =
        {
                        ...
                        if (options.data && options.data.filter && options.data.filter.filters) {
                            ...
                            for (var i = 0; i < options.data.filter.filters.length; i++) {
                                ...
                                if (options.data.filter.filters[i].field === "EnquiryAutoNumber") {
                                    ...
                                    //$scope.EnquiryAutoNumberFilter = options.data.filter.filters[i].value;
                                    //$scope.EnquiryAutoNumberCriteriaFilter = options.data.filter.filters[i].operator;
                                ...
                                if (options.data.filter.filters[i].field === "branchPlant") {
                                    ...
                                    //$scope.BranchPlantFilter = options.data.filter.filters[i].value;
                                    //$scope.BranchPlantCriteriaFilter = options.data.filter.filters[i].operator;
                                }


                                if (options.data.filter.filters[i].field === "carrier") {
                                    carrierColumn = options.data.filter.filters[i].value;
                                    carrierColumnCriteria = options.data.filter.filters[i].operator;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "CompanyName") {
                                    ...
                                    //$scope.CompanyNameValueFilter = options.data.filter.filters[i].value;
                                    //$scope.CompanyNameValueCriteriaFilter = options.data.filter.filters[i].operator;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "SoldToCode") {
                                    ...
                                    //$scope.SoldToCodeFilter = options.data.filter.filters[i].value;
                                    //$scope.SoldToCodeCriteriaFilter = options.data.filter.filters[i].operator;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "Area") {
                                    ...
                                    //$scope.AreaFilter = options.data.filter.filters[i].value;
                                    //$scope.AreaCriteriaFilter = options.data.filter.filters[i].operator;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "Empties") {
                                    ...
                                    //$scope.EmptiesFilter = Empties;
                                    EmptiesCriteria = options.data.filter.filters[i].operator;
                                    //$scope.EmptiesCriteriaFilter = EmptiesCriteria;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "Stock") {
                                    ...
                                    //$scope.AvailableStockFilter = AvailableStock;
                                    AvailableStockCriteria = options.data.filter.filters[i].operator;
                                    //$scope.AvailableStockCriteriaFilter = AvailableStockCriteria;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "ReceivedCapacityPalettes") {
                                    ...
                                    //$scope.ReceivedCapacityPalatesFilter = ReceivedCapacityPalates;
                                    ReceivedCapacityPalatesCriteria = options.data.filter.filters[i].operator;
                                    //$scope.ReceivedCapacityPalatesCriteriaFilter = ReceivedCapacityPalatesCriteria;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "DeliveryLocation") {
                                    ...
                                    //$scope.DeliveryLocationFilter = options.data.filter.filters[i].value;
                                    //$scope.DeliveryLocationCriteriaFilter = options.data.filter.filters[i].operator;
                                }
                                if (options.data.filter.filters[i].field === "AssociatedOrder") {
                                    ...
                                    //$scope.GratisFilter = options.data.filter.filters[i].value;
                                    //$scope.GratisCriteriaFilter = options.data.filter.filters[i].operator;
                                }
                                if (options.data.filter.filters[i].field === "Status") {
                                    ...
                                    //$scope.StatusFilter = options.data.filter.filters[i].value;
                                    //$scope.StatusCriteriaFilter = options.data.filter.filters[i].operator;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "EnquiryDate") {
                                    ...
                                    //$scope.EnquiryDateFilter = EnquiryDate;
                                    //$scope.EnquiryDateCriteriaFilter = EnquiryDateCriteria;
                                }
                                ...
                                if (options.data.filter.filters[i].field === "OrderProposedETD") {
                                    ...
                                    //$scope.RequestDateFilter = RequestDate;
                                    //$scope.RequestDateCriteriaFilter = RequestDateCriteria;
                                }
                            }
                                    ...
                                    if (resoponsedata.Json !== undefined) {
                                        ...
                                        for (var i = 0; i < ListData.length; i++) {
                                            ...
                                            if (enquiryList.length > 0) {
                                                ...
                                                if (enquiryList[0].PromisedDate == "" || enquiryList[0].PromisedDate == undefined || enquiryList[0].PromisedDate == null) {
                                                    enquiryList[0].PromisedDate = enquiryList[0].RequestDate;
                                                }
            ...
            columns: [
                ...
                {
                    field: "EnquiryDate", "title": $rootScope.resData.res_GridColumn_EnquiryDate, type: "date", width: "175px",
                    filterable:
                    {
                        cell:
                ...
                {
                    field: "EnquiryAutoNumber", title: $rootScope.resData.res_GridColumn_EnquiryAutoNumber, template: '<div class="graybgfont" ng-click=\"LoadEnquiryView(#=EnquiryId#, #=IsAvailableStock#)\">#:EnquiryAutoNumber#</div>', type: "string", filterable: { mode: "row", extra: false },
                    width: "100px"
                },
                { field: "Area", title: $rootScope.resData.res_GridColumn_Area, type: "string", filterable: { mode: "row", extra: false }, width: "100px" },
                {
                    field: "AssociatedOrder",
                    "title": $rootScope.resData.res_GridColumn_AssociatedOrder,
                    type: "string",
                    filterable: { mode: "row", extra: false }, width: "175px"
                },
                ...
                //{ field: "SoldToCode", title: "SoldTo", type: "string", filterable: { mode: "row", extra: false }, width: "100px" },
                ...
                {
                    field: "branchPlant",
                    template: "<select class=\"form-control\" style=\"margin:0px !important\"  ng-model=\"dataItem.branchPlant\" ng-Change=\"UpdateBranchPlantOnChange(#=EnquiryId#,dataItem.branchPlant)\"  ng-options=\"obj.DeliveryLocationId as obj.DeliveryLocationCode for obj in bindAllBranchPlant\"><option value=\"\">Select</option></select>",
                    "title": $rootScope.resData.res_GridColumn_branchPlant,
                    type: "string",
                    filterable: {
                ...
                //{
                //    field: "Empties", title: "E", template: "#if(Empties==='C') {#<span class='greenbgfont'><i class='fa fa-check'></i></span> #} else{#<span class='orangebgfont'><i class='fa fa-exclamation-triangle'></i></span>#}#", "text-align": "center", type: "string",
                //    filterable: false,
                //    width: "75px"
                //},
                ...
                {
                    field: "carrier",
                    template: "<select class=\"form-control\" style=\"margin:0px !important\"  ng-model=\"dataItem.carrier\" ng-Change=\"OnCarrierChangeEvent(#=EnquiryId#,dataItem.carrier)\" ng-options=\"obj.CompanyId as obj.CompanyMnemonic for obj in bindAllCarrier#:EnquiryId#\"><option value=\"\">Select</option></select>",
                    "title": $rootScope.resData.res_GridColumn_carrier,
                    type: "string",
                    filterable: true, width: "175px"
                },
                ...
                //{
                //    field: "ReceivedCapacityPalettes", title: "C", template: "<div ng-class=\"{'fontred' : dataItem.ReceivedCapacityPalettes < 0 }\">#=ReceivedCapacityPalettes# / #=Capacity#</div>", "text-align": "center", type: "string", filterable: false,
                //    width: "75px"
                //},
                ...
                //{
                //    field: "TotalPrice", title: "TotalPrice", template: "<div>#=TotalPrice#</div>", "text-align": "center", type: "string", filterable: false,
                //    width: "100px"
                //},

                //{ field: "Capacity", title: "C", template: "#if(IsRecievingLocationCapacityExceed == '0') {#<span class='greenbgfont'><i class='fa fa-check'></i></span> #} else{#<span class='redbgfont'><i class='fa fa-times'></i></span>#}#", "text-align": "center", type: "string", filterable: false, width: "4%" },
                //{
                //    field: "Stock", title: "S", template: "#if(IsAvailableStock === '1') {#<span class='greenbgfont'><i class='fa fa-check'></i></span> #} else if(IsAvailableStock === '0') {#<span class='redbgfont'><i class='fa fa-times'></i></span>#}#", "text-align": "center", type: "string",
                //    filterable: false,
                //    width: "75px"
                //},
                ...
                {
                    field: "Stock",
                    template: "#if(IsAvailableStock === '1') {#<span class='greenbgfont'><i class='fa fa-check'></i></span> #} else if(IsAvailableStock === '0') {#<span class='redbgfont'><i class='fa fa-times'></i></span>#}#",
                    "title": $rootScope.resData.res_GridColumn_Stock,
                    type: "string",
                    filterable: {
                        cell: { showOperators: false, template: $scope.StockFilter },
                        ui: $scope.StockFilter, mode: "row", extra: false, operators: {
                            string: {
                                eq: "Is equal to",
                            }
                        }
                ...
                {
                    field: "Note",
                    template: "<a  ng-hide=\"dataItem.Note === '' || dataItem.Note === null || dataItem.Note === undefined\" ng-click=\"OpenModelPoppupNote(#=EnquiryId#)\"><i class=\"fa fa-sticky-note stickynotecolor\"></i></a>",
                ...
                //{
                //    field: "OrderProposedETD", "title": "Proposed ETD", type: "date",
                //    filterable:
                //    {
                //        cell:
                //        { showOperators: false, template: $scope.datepickerfilter, format: "dd/MM/yyyy HH:mm" },
                ...
                // { field: "RequestDate", title: "Scheduling Date", template: "#if(RequestDate !== '') {#<span class='greenbgfont'><i class='fa fa-check'></i></span> #} else{#<span class=''><i class='fa fa-times'></i></span>#}#", "text-align": "center",  type: "string", filterable: { mode: "row", extra: false } },

                {
                    field: "RequestDate",
                    template: "<div class=\"prepend-icon\"><input type=\"text\" Id=\"{{dataItem.EnquiryId}}\" ng-model='dataItem.RequestDate'  name=\"datepicker\" class=\"form-control\"  placeholder=\"Select a date...\"><i class=\"icon-calendar\"></i></div>",
...

                {
                    ...
                    "title": $rootScope.resData.res_GridColumn_PromisedDate,
                    filterable: false,
                    format: "{0:dd/MM/yyyy}", width: "175px"
                },
                ...
                {
                    field: "Action",
                    title: $rootScope.resData.res_GridColumn_Action, template: "#if(CurrentState == 1) {#<a class=\"greenbgfont approvebtn\" ng-click=\"ApproveEnquiryByEnquiryId(#=EnquiryId#)\"> Approve </a>#}#", type: "string",
                    filterable: false,
                    width: "100px"
                },
            ],
    ...
    $scope.UpdatePromisedDateOnChange = function (enquiryId, PromisedDate) {
        ...
        var enquiryDetails = $scope.GridData.data.filter(function (el) { return parseInt(el.EnquiryId) === parseInt(enquiryId); });
        $scope.OpenReasoncodepopup(enquiryDetails, "PromisedDate");
        ...
        for (var index = 0; index < gridDataArray.length; index++) {
            ...
            if (enquiryRequestDate.length > 0) {
                if (enquiryRequestDate[0].RequestDate === columnValue && enquiryRequestDate[0].branchPlant === columnValueBranchPlant) {
                    ...
                    $scope.OpenReasoncodepopup(enquiryDetails, "ApproveEnquiry");
                }
            }
        };
    ...
    $scope.RejectAllSelectedEnquiry = function () {
        ...
        if (enquiryDetails.length > 0) {
            ...
            $scope.OpenReasoncodepopup(enquiryDetails, "RejectEnquiry");
    ...
    $scope.OpenReasoncodepopup = function (enquiryDetails, eventName) {
    ...
    $scope.ExportToExcel = function () {
        ...
        GrRequestService.ProcessRequestForServiceBuffer(jsonobject).then(function (response) {
            ...
            if (response.data !== undefined) {
                ...
                debugger;
                if (blob.size > 0) {
                    var filName = "InquiryDetails_" + getDate() + ".xlsx";
                    saveAs(blob, filName);
                } else {
