angular.module('glassRUNProduct').factory('pluginsService', [function () {
    ...
    // Handles custom checkboxes ss& radios using jQuery iCheck plugin
        ...
        $('.timepicker').each(function () {
            $(this).timepicker({
                onSelect: function (date) {
                    ...
                    angular.element($('.timepicker')).triggerHandler('input');
                },
...
// Handles custom s checkboxes & radios using jQuery iCheck plugin
function handleiCheck() {
