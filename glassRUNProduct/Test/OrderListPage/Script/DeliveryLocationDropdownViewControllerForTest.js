angular.module("glassRUNProduct").controller('DeliveryLocationDropdownControllerForTest', function ($scope, $http, $state, $sessionStorage, $rootScope, $filter, focus, $location, $ionicModal, GrRequestService, pluginsService) {
...
$scope.SearchControl.InputShipToLocation = selectedShipToLocation;
    ...
    $scope.LoadDeliveryLocationLocationByConfiguration();
